...
pub fn tournament_selection<P, F>(tournament_size: usize) -> Box<Fn(&Population<P, F>, &mut Rng) -> Rc<P>>
    where P: AstNode+Clone,
          F: Fitness
{
    return Box::new(move |pop: &Population<P, F>, rng: &mut Rng| {
